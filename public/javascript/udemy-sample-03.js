require([
    ...
    WebMap, MapView, Expand, BasemapGallery, BasemapToggle, Home, Legend, LayerList, Print, ScaleBar, Search
) {
    // Tutorial Map id: b5cc864eeab34258baa30f8ff9cbfe9e
    // My Map id: ef570ddf875e48b79b4e54489a194a53
    var map = new WebMap({ portalItem: {
        id: "ef570ddf875e48b79b4e54489a194a53"
    } 
});
